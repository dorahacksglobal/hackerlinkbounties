...
contract HackerLink is ERC1155Tradable {
  //    * @param _proxyRegistryAddress The address of the OpenSea/Wyvern proxy registry
  //  *                              
  //  *                              
  constructor(address _proxyRegistryAddress) public ERC1155Tradable("HackerLinkNFT", "HackerLinkNFT", _proxyRegistryAddress) {
		_setBaseMetadataURI("");//nft folder path ,like this: https://hackerlink.io/hackerlink/nft/
	}
	function contractURI() public pure returns (string memory) {
		return "";//https://hackerlink.io/nft/hackerlink.json
	}
