...
import {
  DaobaountyClient,
  DaobaountyQueryClient,
} from "../ts/Daobaounty.client";
import {
  CosmWasmClient,
...
const mnemonic =
  "reduce fire private pull win pear pizza expose donate sausage crash width erase like can choose parade join slot wisdom fatal soccer diamond canvas";
